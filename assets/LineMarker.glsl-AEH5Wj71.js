import{v$ as K,GL as X,GM as ee,Fo as te,Fm as ie,GN as re,GO as ae,Ft as o,GE as se,G0 as oe,GD as ne,Fs as w,GP as ce,GQ as le,Fp as pe,Fr as de,Fu as he,Gn as ve,Fw as ue,GR as A,GS as R,GT as me,GU as fe,G4 as ge,g7 as Se,Fx as Pe,Fy as ye,_ as _e,Fz as C,FA as N,FB as we,FC as E,FD as M,G6 as ze,FF as xe,FG as $e,FH as Te,FJ as V,FK as be,GV as Ve,GW as U,GX as I,GY as ke,GZ as Oe,G_ as De,FL as Fe,n as p,FM as d,g4 as We,G7 as Ce,G$ as B,qR as Me,Gv as Le,l0 as Ge,FR as je,cf as q,xZ as Ae,gF as H,cq as Y,H0 as Re}from"./index-Dg_V7Ho7.js";function J(r){const e=new K,{space:i,anchor:t,hasTip:P,hasScreenSizePerspective:z}=r,u=i===2,g=i===1;e.include(X,r),e.include(ee,r),e.include(te,r);const{vertex:a,fragment:S,varyings:y}=e;ie(a,r),e.attributes.add("position","vec3"),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),y.add("vColor","vec4"),y.add("vpos","vec3",{invariant:!0}),y.add("vUV","vec2"),y.add("vSize","float"),P&&y.add("vLineWidth","float"),a.uniforms.add(new re("nearFar",({camera:l})=>l.nearFar),new ae("viewport",({camera:l})=>l.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
...
}`),P&&(e.include(R),S.constants.add("relativeMarkerSize","float",me/A).constants.add("relativeTipLineWidth","float",fe).code.add(o`
